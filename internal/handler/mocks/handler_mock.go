...
func (mr *MockURLServiceMockRecorder) GetStats(ctx any) *MockURLServiceGetStatsCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetStats", reflect.TypeOf((*MockURLService)(nil).GetStats), ctx)
	return &MockURLServiceGetStatsCall{Call: call}
}

// MockURLServiceGetStatsCall wrap *gomock.Call
type MockURLServiceGetStatsCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockURLServiceGetStatsCall) Return(urls, users int, err error) *MockURLServiceGetStatsCall {
	c.Call = c.Call.Return(urls, users, err)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockURLServiceGetStatsCall) Do(f func(context.Context) (int, int, error)) *MockURLServiceGetStatsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockURLServiceGetStatsCall) DoAndReturn(f func(context.Context) (int, int, error)) *MockURLServiceGetStatsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
