...
func (x *ListUserURLsRequest) Reset() {
	*x = ListUserURLsRequest{}
	mi := &file_api_shortner_shortner_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_api_shortner_shortner_proto_rawDesc = "" +
	"\n" +
	"\x1bapi/shortner/shortner.proto\x12\bshortner\"%\n" +
	...
	"\x13ListUserURLsRequest2\xec\x01\n" +
	"\x10ShortenerService\x12G\n" +
	"\n" +
	"ShortenURL\x12\x1b.shortner.URLShortenRequest\x1a\x1c.shortner.URLShortenResponse\x12D\n" +
	"\tExpandURL\x12\x1a.shortner.URLExpandRequest\x1a\x1b.shortner.URLExpandResponse\x12I\n" +
	"\fListUserURLs\x12\x1d.shortner.ListUserURLsRequest\x1a\x1a.shortner.UserURLsResponseB;Z9github.com/KV2013/url-shortner-go/api/shortner;shortnerpbb\beditionsp\xe8\a"

var file_api_shortner_shortner_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_api_shortner_shortner_proto_goTypes = []any{
	...
	(*ListUserURLsRequest)(nil), // 6: shortner.ListUserURLsRequest
}
var file_api_shortner_shortner_proto_depIdxs = []int32{
	...
	6, // 3: shortner.ShortenerService.ListUserURLs:input_type -> shortner.ListUserURLsRequest
